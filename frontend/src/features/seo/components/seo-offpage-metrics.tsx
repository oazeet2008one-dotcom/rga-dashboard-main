...
export function SeoOffPageMetrics() {
    ...
    const pages: PageView[] = [
        {
            title: "Backlinks",
            totalCount: 0, // Mock total
            items: [
                { label: "Dofollow", count: 0, percentage: 100 },
                { label: "Nofollow", count: 0, percentage: 100 },
                { label: "UGC", count: 0, percentage: 100 },
                { label: "Sponsored", count: 0, percentage: 100 },
                { label: "Text", count: 0, percentage: 100 },
                { label: "Redirect", count: 0, percentage: 100 },
                { label: "Image", count: 0, percentage: 100 },
                { label: "Form", count: 0, percentage: 100 },
                { label: "Governmental", count: 0, percentage: 100 },
                { label: "Educational", count: 0, percentage: 100 },
            ]
        },
        {
            ...
            items: [
                ...
                { label: "Governmental", count: 0, percentage: 100 },
                { label: "Educational", count: 0, percentage: 100 },
                { label: ".gov", count: 0, percentage: 100 },
                { label: ".edu", count: 0, percentage: 100 },
                { label: ".com", count: 0, percentage: 100 },
                { label: ".net", count: 0, percentage: 100 },
                { label: ".org", count: 0, percentage: 100 },
            ]
        },
        {
